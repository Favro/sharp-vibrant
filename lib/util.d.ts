...
export declare function hexToRgb(hex: string): Vec3 | null;
export declare function rgbToHex(r: number, g: number, b: number): string;
export declare function rgbToHsl(ir: number, ig: number, ib: number): Vec3;
export declare function hslToRgb(h: number, s: number, l: number): Vec3;
export declare function rgbToXyz(ir: number, ig: number, ib: number): Vec3;
export declare function xyzToCIELab(ix: number, iy: number, iz: number): Vec3;
